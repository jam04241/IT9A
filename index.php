    ...
    <div class="main">
        ...
        <div class="content">
            <div class="container-sm" style="background-color: aqua;">
                ...
                <table class="table table-sm table-strip my-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class='btn btn-primary btn-sm' href='edit.php?student_id=<?= $row['student_id'];
                                    ?>'>Edit</a>
                                <a class='btn btn-danger btn-sm' href='database/deletestudent.php?student_id=<?=$row['student_id'];
                                    ?>'>Delete</a>
                            </td>
                        </tr>
                        <?php endwhile; ?>
